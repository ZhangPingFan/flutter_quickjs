...
class Quickjs {
  ...
  static final Pointer Function(Pointer) jsGetGlobalObject = ffiqjsLib
    ...
    .asFunction();
  static final Pointer Function(Pointer, Pointer<Utf8>, int, Pointer<Utf8>, int) jsEval = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer<Utf8>, Int64, Pointer<Utf8>, Int32)>>("jsEval")
    .asFunction();
  static final Pointer Function(Pointer, Pointer, Pointer, int, Pointer) jsCall = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer, Pointer, Int32, Pointer)>>("jsCall")
    .asFunction();
  ...
  static final Pointer<Utf8> Function(Pointer, Pointer) jsToCString = ffiqjsLib
    .lookup<NativeFunction<Pointer<Utf8> Function(Pointer, Pointer)>>("jsToCString")
    .asFunction();
  ...
  static final Pointer Function(Pointer, Pointer, int) jsGetProperty = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer, Int32)>>("jsGetProperty")
    .asFunction();
  static final Pointer Function(Pointer, Pointer, Pointer<Utf8>) jsGetPropertyStr = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer, Pointer<Utf8>)>>("jsGetPropertyStr")
    .asFunction();
  static final Pointer Function(Pointer, Pointer, int) jsGetPropertyUint32 = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer, Int32)>>("jsGetPropertyUint32")
    .asFunction();
  static final int Function(Pointer, Pointer, Pointer, Pointer, int) jsGetOwnPropertyNames = ffiqjsLib
    .lookup<NativeFunction<Int32 Function(Pointer, Pointer, Pointer, Pointer, Int32)>>("jsGetOwnPropertyNames")
    .asFunction();
  ...
  static final int Function(Pointer, int) jsPropertyEnumGetAtom = ffiqjsLib
    .lookup<NativeFunction<Int32 Function(Pointer, Int32)>>("jsPropertyEnumGetAtom")
    .asFunction();
  ...
  static final Pointer Function(Pointer, int) getValueAtIndex = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Int32)>>("getValueAtIndex")
    .asFunction();
  static final void Function(Pointer, int, Pointer) setValueAtIndex = ffiqjsLib
    .lookup<NativeFunction<Void Function(Pointer, Int32, Pointer)>>("setValueAtIndex")
    .asFunction();
  ...
  static final Pointer Function(Pointer, Pointer<Utf8>) jsNewString = ffiqjsLib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer<Utf8>)>>("jsNewString")
    .asFunction();
  ...
  static final void Function(Pointer) registerGlobalDartCallback = ffiqjsLib
    .lookup<NativeFunction<Void Function(Pointer)>>("registerGlobalDartCallback")
    .asFunction();
